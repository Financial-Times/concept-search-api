...
func (tc failClient) query(indexName string, query elastic.Query, filters elastic.Query, resultLimit int) (*elastic.SearchResult, error) {
...
func (mc mockClient) query(indexName string, query elastic.Query, filters elastic.Query, resultLimit int) (*elastic.SearchResult, error) {
